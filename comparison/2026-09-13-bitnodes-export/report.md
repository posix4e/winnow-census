...
| bitnodes_export | Unavailable — Unavailable | Public dated CSV with retained addresses and per-address last-connection dates in export_date; not a simultaneous reachable population. | {"activeAdvertisedCompactFilters": 6283, "activeByPublishedRetention": 25820, "retainedAdvertisedCompactFilters": 13501, "retainedExportEndpoints": 54187} | Maintainer confirms own measurements using shared ayeowch/bitnodes crawler; discovery inputs may overlap. Same project as dashboard, not another independent source. |
